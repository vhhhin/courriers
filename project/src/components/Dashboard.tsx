  ...
  const defaultActivities = [
    {
      ...
      title: language === "ar" ? "بريد وارد جديد" : "Nouveau courrier arrivé",
      time: language === "ar" ? "منذ ساعتين" : "Il y a 2 heures",
    },
    {
      type: "outgoing" as const,
      title: language === "ar" ? "تم إرسال البريد" : "Courrier départ envoyé",
      time: language === "ar" ? "منذ 3 ساعات" : "Il y a 3 heures",
    },
    {
      type: "decision" as const,
      title: language === "ar" ? "قرار جديد" : "Nouvelle décision ajoutée",
      time: language === "ar" ? "منذ 5 ساعات" : "Il y a 5 heures",
    },
  ];

  const activities = searchResults?.length ? searchResults : defaultActivities;
